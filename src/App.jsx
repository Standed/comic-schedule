...
const ScheduleTable = () => {
  ...
  const rows = [
    ...
    { id: 12, date: "05.12", title: "导演思维：影视级视听语言核心精讲", teacher: "洛洛", tags: ["直播课"] },
    { id: 13, date: "05.13", title: "作业日：运用镜头组接原则完成画面优化", teacher: "", tags: ["课后作业"] },
    { id: 14, date: "05.14", title: "后期剪辑：从碎片素材到高质感成片的视听组接实战", teacher: "洛洛", tags: ["直播课"] },
    { id: 15, date: "05.15", title: "作业日：优化并完成剪辑初稿", teacher: "", tags: ["课后作业"] },
    { id: 16, date: "05.16", title: "案例拆解：AI仿真人短剧完整流程演示与查漏补缺", teacher: "洛洛", tags: ["直播课", "作业提交"], highlight: true },
